...
""")
            ...
            let buildPhases = [
                ...
                try createResourcesPhase(
                    in: pbxProj,
                    productType: productType,
                    resourceBundleProducts: target.resourceBundleProducts,
...
""")
    ...
    private static func createResourcesPhase(
        ...
        guard productType.isBundle
                && !(inputs.resources.isEmpty && resourceBundleProducts.isEmpty)
        else {
            return nil
        }
...
""")
        ...
        let produceResources = try resourceBundleProducts.map(productReference)
